...
<h2>Retreat Listing for Retreat #{{$registrations[0]->retreat->idnumber}} - {{$registrations[0]->retreat->title}}</h2> 
 ...
 <table width="100%">
        ...
        <th class="row-3 row-phone">Cell phone</th>
        <th class="row-4 row-phone">Home phone</th>
        <th class="row-5 row-email">Email</th>
        <th class="row-6 row-parish">Parish</th>
    ...
    <tr>
        ...
        <td>{{$registration->retreatant->address_primary_street}} {{$registration->retreatant->address_primary_city}}, {{$registration->retreatant->address_primary_state}}  {{$registration->retreatant->address_primary_postal_code}}</td>
